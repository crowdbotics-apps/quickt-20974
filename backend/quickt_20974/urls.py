"""quickt_20974 URL Configuration
...
admin.site.site_header = "quickt"
admin.site.site_title = "quickt Admin Portal"
admin.site.index_title = "quickt Admin"

# swagger
api_info = openapi.Info(
    title="quickt API",
    default_version="v1",
    description="API documentation for quickt App",
)
